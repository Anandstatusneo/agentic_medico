...
![logo](https://github.com/Anandstatusneo/agentic_medico/blob/main/assets/logo_rounded.png)

<h1 align="center"><strong>⚕️ Agentic Medico :<h6 align="center">AI-powered multi-agentic system for medical diagnosis and assistance</h6></strong></h1>
...
[![GitHub Issues](https://img.shields.io/github/issues/Anandstatusneo/agentic_medico.svg?style=for-the-badge)](https://github.com/Anandstatusneo/agentic_medico/issues)
...
>
> To use Unstructured.io based solution, refer release - [v2.0](https://github.com/Anandstatusneo/agentic_medico/tree/v2.0).
...
The **Agentic Medico** is an **AI-powered chatbot** designed to assist with **medical diagnosis, research, and patient interactions**.  
...
<!-- The **Agentic Medico** is an advanced AI-powered chatbot system designed to assist in medical diagnosis, research, and patient interactions.
...
If you like what you see and would want to support the project's developer, you can <a href="https://www.buymeacoffee.com/Anandstatusneo" target="_blank"><img src="https://www.buymeacoffee.com/assets/img/custom_images/orange_img.png" alt="Buy Me A Coffee" style="height: 41px !important;width: 174px !important;box-shadow: 0px 3px 2px 0px rgba(190, 190, 190, 0.5) !important;-webkit-box-shadow: 0px 3px 2px 0px rgba(190, 190, 190, 0.5) !important;" ></a> ! :)

📂 **For an even more detailed demo video**: Check out [`agentic_medico-v1.9`](assets/agentic_medico-v1.9_Compressed.mp4). 📽️
...
Contributions are welcome! Please check the [issues](https://github.com/Anandstatusneo/agentic_medico/issues) tab for feature requests and improvements.  
...
@misc{Anand2025,
  Author = {Anand Yadav},
  Title = {Agentic Medico},
  Year = {2025},
  Publisher = {GitHub},
  Journal = {GitHub repository},
  Howpublished = {\url{https://github.com/Anandstatusneo/agentic_medico}}
}
```
...
For any questions or collaboration inquiries, reach out to **Anand Yadav** on:  

🔗 **LinkedIn**: [https://www.linkedin.com/in/Anandstatusneo](https://www.linkedin.com/in/Anandstatusneo)

🔗 **GitHub**: [https://github.com/Anandstatusneo](https://github.com/Anandstatusneo)
